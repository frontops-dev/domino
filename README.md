...
7. **Implicit Dependencies**: Expands Nx `implicitDependencies` against known project **names**, including glob patterns (`shop-*`, `integration-*-module`) and `!` exclusions — same idea as Nx/minimatch, not path globs
